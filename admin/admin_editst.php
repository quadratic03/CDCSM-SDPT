...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <button class="btn-add" onclick="window.location.href='admin_registration.php';" style="background-color: #003366; color: white; padding: 10px; border: none; border-radius: 5px; cursor: pointer; margin-bottom: 20px;">Add New Staff</button>
