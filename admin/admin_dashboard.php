...
<body>
    <div class="container">
        <!-- Sidebar -->
    <?php include '../components/sidebar.php'; renderSidebar("admin", "admin_dashboard.php"); ?>
        ...
        <div class="main-content">
            ...
            <div class="grid-container">
                ...
                <div class="grid-item">
                    <a href="admin_editst.php">
                        <i class="fas fa-user"></i>
                        <p>Staff Account</p>
                    </a>
                </div>
                <div class="grid-item">
                    <a href="admin_editstud.php">
                        <i class="fas fa-user-circle"></i>
                        <p>Student Account</p>
                    </a>
                </div>
                <div class="grid-item">
                    <a href="admin_ssc.php">
