...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <button class="btn-add" onclick="window.location.href='admin_registration.php';" style="background-color: #003366; color: white; padding: 10px; border: none; border-radius: 5px; cursor: pointer; margin-bottom: 20px;">Add New Student</button>
            <!-- Staff Account Table -->
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td>1. Robin Padilla</td>
                        <td>robin.padilla@gmail.com</td>
                        <td>12345678900</td>
                        <td>
                            <button class="btn-edit">Edit</button>
                            <button class="btn-view" style="background-color: #17a2b8; color: white; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer;">View Profile</button>
                            <button class="btn-delete">Delete</button>
                        </td>
                    </tr>
                    <tr>
                        <td>2. Bini Mikha</td>
                        <td>bini.mikha@gmail.com</td>
                        <td>12345678900</td>
                        <td>
                            <button class="btn-edit">Edit</button>
                            <button class="btn-view" style="background-color: #17a2b8; color: white; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer;">View Profile</button>
