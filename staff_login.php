...
<body class="bg-white flex items-center justify-center min-h-screen">
    <div class="flex flex-col items-center">
        <img alt="CDO logo" class="mb-4 rounded-full -mt-12" height="200" src="staff/CSO-logo.png" width="200">
    ...
    <div class="ml-10 p-8 bg-blue-900 rounded-lg shadow-lg w-80">
        <h2 class="text-white text-xl mb-4">Staff Login</h2>
        <form method="post" action="staff/staff_dashboard.php">
            <div class="mb-4">
            ...
            <div class="mb-4 text-right">
                ...
                <div class="button-container">
                <button class="login-btn" type="submit" href="staff/staff_dashboard.php" >Login</button>
</div>
